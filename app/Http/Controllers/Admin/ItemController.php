...
class ItemController extends Controller
{
    ...
    {
        $items = Item::all();
        return view('admin.item.index',compact('items',$items));
    }
    ...
    public function create()
    {
        ...
        return view('admin.item.create',compact('categories',$categories));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.item.edit',compact('item','categories',$item,$categories));
    }
